...
>
         <nav className="w-full xl:flex xl:flex-1 xl:justify-center">
      ...
      <li key={key} className={menuItem.submenu && "group relative"}>
        {menuItem.submenu ? (
          ...
          <div className="mt-7 flex items-center gap-6 xl:mt-0">
            ...
            <Link
              href="#"
              className="flex items-center gap-2 justify-center rounded-lg bg-black px-7.5 py-2.5 text-regular text-white duration-300 ease-in-out hover:bg-primaryho"
            >
              Contact Us
